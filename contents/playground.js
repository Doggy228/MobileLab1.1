...
console.log("Методи, що повертають суму або різницю поточного об'єкта та об'єкта, що отриманий як вхідний параметр");

time2.add(time3).toString();
time2.sub(time3).toString();

console.log("Методи, що повертають суму або різницю двох об'єктів, що отримані як вхідні параметри");
